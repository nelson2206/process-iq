...
${diShapes}${diEdges}    </bpmndi:BPMNPlane>
  ...
  const TEMAS_PPTX = {
    mbc: {
      ...
      dk1: '003478', lt2: 'E3E2DA', acento: 'FF0054', gris: '5E6E8C',
      sep: 'D0CEC1', chipRol: 'F7C29E', teal: '00B0BD',
      rosa: 'F05C95', verde: '44B757', arena: 'E4E3DD', circulo: 'FF0054',
      ...
      portada: 'mbc', portadaFondo: '003478', portadaTexto: 'FFFFFF', portadaSub: 'E3E2DA',
      cierre: false
    },
    bbva: {
      ...
      dk1: '001391', lt2: 'F7F8F8', acento: '85C8FF', gris: '5C6B8A',
  ...
  function exportPptx(tema) {
    ...
    if (T.portada === 'bbva') {
      ...
      // Calco de "Portada Básica" del Libro de estilo MBC: fondo azul MBC,
      // título dominante arriba a la izquierda, logotipo blanco abajo a la derecha.
      s1.addText('PROCESSIQ  ·  BUSINESS CONSULTING', {
        x: 0.92, y: 0.6, w: 8, h: 0.28, fontSize: 10, bold: true,
        color: M_FUCSIA, fontFace: T_FONT, charSpacing: 1.6 });
      s1.addShape('rect', { x: 0.92, y: 1.02, w: 1.6, h: 0.06, fill: { color: M_FUCSIA } });
      s1.addText(state.meta.name || 'Diagnóstico de proceso', {
        x: 0.92, y: 1.3, w: 11.5, h: 2.6, fontSize: 40, color: T.portadaTexto,
        fontFace: T_FONT_TITULO, valign: 'top' });
      s1.addText(`Industria: ${state.meta.industry || '—'}   ·   Macroproceso: ${state.meta.macroprocess || '—'}`, {
        x: 0.92, y: 4.1, w: 11.5, h: 0.32, fontSize: 13, color: T.portadaSub, fontFace: T_FONT });
      s1.addText(`${state.meta.client || 'Business Consulting'}. ${PIE_FECHA}`, {
        x: 0.92, y: 4.55, w: 11.5, h: 0.24, fontSize: 11, color: T.portadaSub, fontFace: T_FONT });
      s1.addImage({ data: T.logoInv, x: 11.71, y: 6.82, w: T.logoW, h: T.logoH });
      s1.addText('Documento confidencial — uso interno', {
        x: 0.92, y: 6.93, w: 6, h: 0.24, fontSize: 8, color: T.portadaSub, fontFace: T_FONT });
    }
    ...
    (function addLegendSlide() {
      ...
      row(x1, y, (cx, cy) => sl.addShape('rect', { x: cx, y: cy - ICON/2, w: 0.6, h: ICON, fill: { color: 'FFFFFF' }, line: { color: DARK, width: 1 }, rectRadius: 0.05 }), 'Actividad / tarea'); y += 0.55;
      row(x1, y, (cx, cy) => sl.addShape('rect', { x: cx, y: cy - ICON/2, w: 0.6, h: ICON, fill: { color: 'F9F9F8' }, line: { color: DARK, width: 1 }, rectRadius: 0.05 }), 'Tarea de sistema'); y += 0.55;
      ...
      row(x1, y, (cx, cy) => sl.addShape('line', { x: cx, y: cy, w: 0.6, h: 0.01, line: { color: GRAY, width: 1.5, endArrowType: 'triangle' } }), 'Flujo de secuencia'); y += 0.5;
      row(x1, y, (cx, cy) => sl.addShape('line', { x: cx, y: cy, w: 0.6, h: 0.01, line: { color: GRAY, width: 1.5, dashType: 'dash', endArrowType: 'triangle' } }), 'Flujo de mensaje (entre carriles)');
    ...
    if (allPains.length > 0) {
      ...
      top3.forEach((p, i) => {
        ...
        sl.addShape('rect', { x: 1, y, w: 11.8, h: 1.7, fill: { color: 'FFFFFF' }, line: { color: M_SEP, width: 0.5 } });
    ...
    if (allPains.length > 0) {
      ...
      // Cuadrantes
      sl.addShape('rect', { x: px, y: py, w: pw / 2, h: ph / 2, fill: { color: 'D9F1DD' }, line: { color: M_SEP, width: 0.5 } });
      sl.addShape('rect', { x: px + pw / 2, y: py, w: pw / 2, h: ph / 2, fill: { color: 'BFFBFF' }, line: { color: M_SEP, width: 0.5 } });
      sl.addShape('rect', { x: px, y: py + ph / 2, w: pw / 2, h: ph / 2, fill: { color: 'FFFFFF' }, line: { color: M_SEP, width: 0.5 } });
      sl.addShape('rect', { x: px + pw / 2, y: py + ph / 2, w: pw / 2, h: ph / 2, fill: { color: 'FFBAD1' }, line: { color: M_SEP, width: 0.5 } });
      ...
      sl.addText('FILL-INS', { x: px, y: py + ph - 0.35, w: pw / 2, h: 0.3, fontSize: 11, color: GRAY, bold: true, align: 'center' });
    ...
    s5.addShape('rect', { x: 0.5, y: 5.1, w: 2.9, h: 1.5, fill: { color: 'FFFFFF' }, line: { color: M_SEP, width: 0.5 } });
    s5.addText(t1, { x: 0.5, y: 5.1, w: 2.9, h: 1.5, fontSize: 13, color: DARK, align: 'center', valign: 'middle', bold: true });
    s5.addShape('rect', { x: 3.55, y: 5.1, w: 2.9, h: 1.5, fill: { color: 'FFFFFF' }, line: { color: M_SEP, width: 0.5 } });
    s5.addText(t2, { x: 3.55, y: 5.1, w: 2.9, h: 1.5, fontSize: 13, color: DARK, align: 'center', valign: 'middle', bold: true });
    s5.addShape('rect', { x: 6.6, y: 5.1, w: 2.9, h: 1.5, fill: { color: 'FFFFFF' }, line: { color: M_SEP, width: 0.5 } });
    ...
    sf.addShape('rect', { x: 0.4, y: 1.4, w: 6.2, h: 2.6, fill: { color: 'FFFFFF' }, line: { color: M_SEP, width: 0.5 } });
    ...
    sf.addShape('rect', { x: 6.8, y: 1.4, w: 6.2, h: 2.6, fill: { color: 'FFFFFF' }, line: { color: M_SEP, width: 0.5 } });
    ...
    sf.addShape('rect', { x: 0.4, y: 4.1, w: 6.2, h: 2.4, fill: { color: 'FBE1CF' }, line: { color: M_SEP, width: 0.5 } });
    ...
    // Bloque 4: Quick wins
    sf.addShape('rect', { x: 6.8, y: 4.1, w: 6.2, h: 2.4, fill: { color: 'D9F1DD' }, line: { color: M_SEP, width: 0.5 } });
